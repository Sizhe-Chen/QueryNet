...
config.model.name = 'densenet'#'resnet_preact'
...
config.train.use_apex = False#True
...
config.train.output_dir = 'experiments/' + config.model.name
...
config.scheduler.epochs = 50#160
